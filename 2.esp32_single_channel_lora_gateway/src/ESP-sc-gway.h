...
#define _EMAIL "bibiana.rivadeneira@gmail.com"
#define _PLATFORM "ESP32"
#define _LAT -33.113412332923005
#define _LON -64.3284786120057
#define _ALT 440

// ntp
#define NTP_TIMESERVER "ar.pool.ntp.org"	// Country and region specific
...
wpas wpa[] = {
    ...
    { "Fonexa", "Sandero-AB322TR" },
    //{ "Fibertel WiFi180", "0143636679" },
    //{ "Querty", "0303456!" },
    { "" , "" }
};
